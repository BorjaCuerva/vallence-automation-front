...
<template>
  <section class="relative not-prose scroll-mt-[72px]">
    ...
    >
      <div class="text-center md:mx-auto mb-8 md:mb-12 lg:max-w-2xl max-w-xl sm:mx-auto">
        <p
                ...
                <div class="flex flex-row max-w-none">
                  <div class="flex justify-center">
                    <svg
                      ...
                      width="1em"
                    >
                      <use xlink:href="#ai:tabler:check"></use>
                    </svg>
                  </div>
                  <div class="mt-0.5">
                    <h3
          ...
          <div class="md:basis-1/2 md:mt-0 mt-10" aria-hidden="true">
            <div class="relative m-auto max-w-4xl">
              <img
                ...
                srcset="
                  https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=400&amp;q=80&amp;h=400 400w,
                  https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=768&amp;q=80&amp;h=768 768w
                "
                style="
                  object-fit: cover;
