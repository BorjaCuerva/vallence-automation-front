        ...
        <div class="md:flex md:gap-16 md:flex-row-reverse">
          <div class="md:basis-1/2 self-center">
            <div class="mb-12 dark:text-slate-400 text-lg">
              ...
              Minimice riesgos y maximice productividad con nuestro amplio suministro de
              piezas de automatización y control.
            </div>
                ...
                <div class="flex flex-row max-w-none">
                  ...
                  <div class="mt-0.5">
                    ...
                    <p class="text-muted mt-3 dark:text-slate-700 ml-2 rtl:ml-0 rtl:mr-2">
                      ...
                      pieza que necesite al mejor precio.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="md:basis-1/2 md:mt-0 mt-10" aria-hidden="true">
            <div class="relative m-auto max-w-4xl">
              <img
                ...
                loading="lazy"
                src="/images/pexels-fox-1004-58267-17716910.jpg"
